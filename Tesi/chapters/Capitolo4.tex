...
Lo sviluppo è cominciato con estendere il componente Angular delle mappe già esistente nell'Ui-Kit, che presentava solamente l'integrazione degli elementi base di OpenLayers e un supporto alla sovrapposizione multipla di layer differenti.
Il candidato, sotto supervisione del tutor aziendale, ha poi creato una nuova pagina all'interno dell'applicazione web, dove ha importato il componente delle mappe, così da poter integrare il supporto ai protocolli OGC richiesti e testare le mappe censite.
\\Lo sviluppo si è poi dedicato al supporto del formato GeoJSON, selezionando come prima mappa quella delle frane in Toscana, fornita da IdroGEO. Tale scelta è stata fatta poiché queste mappe possono essere scaricate localmente e caricate all'interno del progetto, lavorando così in un ambiente locale senza dover contattare alcun servizio esterno, riducendo il rischio di errore dovuto da problemi di connessione, tempi di risposta lenti o problemi di disservizio.

* spiegare qui cosa ho fatto *
