...
\\Per fare ciò, è stata selezionata come prima mappa da testare quella delle frane in Toscana, fornita da IdroGEO, in quanto tutte quelle fornite da questo ente, possono essere scaricate localmente e caricate all'interno del progetto, senza dover contattare alcun servizio esterno. Ciò facilità il lavoro di programmazione, riducendo il rischio di errore dovuto da eventuali problemi di disservizio dei server di mappe esterni, come ad esempio, una mappa fornita dal GeoPortale Nazionale tramite WMS potrebbe risultare non disponibile.
\\In questa fase, le parti di codice che hanno subito più modifiche sono le classi BuildLayer.ts e MapModel.ts, le quali si occupano di far istanziare l'oggetto della mappa con proprietà differenti, in base al tipo di formato passato come argomento.
