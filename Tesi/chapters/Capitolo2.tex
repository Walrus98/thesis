...
Infine verrano esplicate OpenLayers e GeoServer, due tecnologie fondamentali per la visualizzazione e la gestione di dati geospaziali.
...
\begin{itemize}
      ...
      \item \textit{GetFeature}: è la richiesta principale nel protcollo WFS in quanto consente agli utenti di recuperare la feature interessata. I parametri inclusi nella richiesta comprendono il nome della feature, il tipo di formato desiderato, la sua proiezione, ecc..
