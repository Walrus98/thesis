...
% \\Da aggiungere: La differenza principale rispetto al servizio WMS è che nel caso del WFS, il server non invia l'immagine della mappa già pronta per la sua rappresentazione. Invece, trasmette dati grezzi, come numeri, coordinate e altre proprietà, che devono essere interpretati e visualizzati dal client.
