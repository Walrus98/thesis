...
\\Questo consente di memorizzare tutti i dati delle mappe, potenzialmente anche esposte medianti protocolli diversi, sotto un unico server. Tale pratica non solo semplifica la gestione e la manutenzione dei dati geospaziali, ma dal punto di vista del client, viene offerta l'illusione che tutte le mappe siano contenute direttamente su un unico server. La centralizzazione favorisce anche l'utilizzo di meccanismi di caching:
% Centralizzare le mappe su un unico servzio semplifica GeoS semplifica notevolmente la gestione e il mantenimento dei dati geospaziali, in quanto non è più necessario cercare le mappe su diversi server esterni, riducendo così la complessità e il rischio di errori
...
Questo consente a GeoServer di rispondere più rapidamente alle richieste per le stesse mappe, utilizzando i dati già memorizzati nella cache anziché elaborarli nuovamente.
