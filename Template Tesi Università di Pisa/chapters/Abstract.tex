...
\begin{itemize}
    ...
    \item sviluppo di un backend per la fornitura delle mappe in formato conforme agli standard OGC e ai formati dati geospaziali richiesti;
    ...
    \item documentazione dettagliata del lavoro svolto, inclusi le tecnologie utilizzate, le scelte progettuali e le modalità di utilizzo del prodotto.
\end{itemize}
