...
GeoServe utilizza Spring come Framework per gestire molte delle sue funzionalità, mentre per l'interfaccia utente  Wicket. L'API REST è implementata utilizzando il framework spring-mvc-framework.
