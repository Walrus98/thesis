...
% nota per samuele futuro: la cache è stata fatta perché altrimenti ci si beccava il rate limiting
...
\subsubsection{Struttura di GeoServer}
Supporta diversi tipi fonti di mappe, le più importanti sono:
\begin{itemize}
      \item WMS, WMTS, WFS, WCS, TMS per i servizi di mappe
      \item GeoPackage, ArcGrid, GeoTIFF, ImageMosaic, WorldImage per
